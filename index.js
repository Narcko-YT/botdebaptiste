...
client.on('guildMemberAdd', member => {
    member.guild.channels.cache.get(config.greeting.channel).send(`${member}`, new Discord.MessageEmbed()
        .setDescription(`<a:fleche:781549070607056937>${member} a rejoint le serveur. 
        <a:fleche:781549070607056937> Nous sommes désormais ${member.guild.memberCount} ! 🎉`)
        .setImage('https://i.pinimg.com/originals/87/23/6d/87236de940fd5cefd8f49405c78cc572.gif')
        .setColor('#00ff00'))
...
client.on('guildMemberRemove', member => {
    member.guild.channels.cache.get(config.greeting.channel).send(new Discord.MessageEmbed()
        .setDescription(`<a:fleche:781549070607056937>${member} a quitté le serveur,
        <a:fleche:781549070607056937>que le ténébre te haïssent!🙃`)
        .setImage('https://i.pinimg.com/originals/1d/19/12/1d19120203589cd2b8996e51bb3644d5.gif')
        .setColor('#ff0000'))
})
client.on('ready', () => {
    ...
    let i = 0
    setInterval(() => {
        client.user.setActivity(statuses[i](), {type: "STREAMING", url: "https://www.twitch.tv/narcko_ytb"})
        i = ++i % statuses.length
    }, 1e4)
})
